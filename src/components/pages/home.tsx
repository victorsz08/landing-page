...
export function Home() {
  return (
    <section className="h-screen flex justify-around items-center px-16 max-sm:flex-col
    max-sm:pt-16 max-sm:px-8 max-sm:w-full max-sm:h-full max-sm:gap-10">
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-2 text-5xl font-bold text-slate-100
        ...
        <small className="text-base font-light text-slate-300 max-sm:text-center max-sm:text-xs
        max-sm:w-full">
        ...
        <section className="mt-6 flex items-center gap-3 max-sm:flex-col max-sm:gap-2">
          <Button asChild className="cursor-pointer text-lg font-light py-6 max-sm:text-sm max-sm:w-full">
          ...
          <Button
            ...
            className="cursor-pointer bg-transparent border-red-600 text-red-600 hover:bg-transparent
                        hover:filter hover:opacity-60 text-lg font-light py-6 max-sm:w-full max-sm:text-sm"
            variant="outline"
          >
