...
export function About() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.h1 className="text-2xl font-bold text-slate-100 max-sm:text-xl" variants={itemVariants}>
          🔥Consultoria online personalizada: Treinos Avançados para Resultados Rápidos e Eficazes
        </motion.h1>
        ...
        >
          <motion.p custom={0} variants={paragraphVariants}>
            Se você está cansado de treinar sem ver resultados e quer evoluir de verdade, eu tenho o método certo para
            você! Minha consultoria online é focada em resultados reais, com estratégias testadas e comprovadas
            cientificamente para máximo desempenho muscular no menor tempo possível.
          </motion.p>

          <motion.p custom={1} variants={paragraphVariants}>
            🔥 Treinos Otimizados para o máximo resultado em qualquer objetivo! – são Protocolos de musculação com
            técnicas avançadas para acelerar seus ganhos.
          </motion.p>
        </div>
